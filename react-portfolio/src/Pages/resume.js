...
function ResumePage(){
    ...
    return(
        <div className='layout'>
            ...
            <p className="paragraph">FLorem ipsum dolor sit amet, consectetur adipiscing elit. Ut in diam nec purus tristique commodo. Proin sed justo euismod, accumsan ex nec, molestie tellus. Fusce gravida consequat mi, vel auctor dui tincidunt ac. 
